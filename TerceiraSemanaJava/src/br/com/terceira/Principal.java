...
public class Principal {
	...
	public static void main(String[] args) {
		...
		/*
		 * Usuario u = new Usuario(); u.setNmeUsuario("Janaína Maciel");
		 * u.setUsrUsuario("janaina.maciel"); u.setIdt(dao.cadastrarUsuario(u,
		 * "3107").longValue()); dao.verificarUsuarioESenha(u.getUsrUsuario(), "3107");
		 * u.setNmeUsuario("Janaína Maciel"); dao.editarUsuario(u); u =
		 * dao.buscarUsuario(u.getIdt()); System.out.println(u.getNmeUsuario());
		 */
