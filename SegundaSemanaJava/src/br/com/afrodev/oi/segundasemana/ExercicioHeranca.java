...
import br.com.afrodev.oi.segundasemana.dao.AnimalDAO;
...
public class ExercicioHeranca {
	...
	private static int deletarAnimalPorIdentificador(AnimalDAO dao, Scanner sc) {
		...
		Long identificador = Leitor.lerValor("Qual registro deseja deletar? ", sc, 0L);
	...
	private static Animal cadastrarGato(Scanner sc) {
		Gato a = new Gato();
		a.setIdade(Leitor.lerValor("Qual a idade? ", sc, a.getIdade()));
		a.setNome(Leitor.lerValor("Qual o nome? ", sc));
		a.setPeso(Leitor.lerValor("Qual o peso? ", sc, a.getPeso()));
		a.setTamanho(Leitor.lerValor("Qual o tamanho? ", sc, a.getTamanho()));
		a.setPossuiCaixaDeAreia(Leitor.lerValor("Possui caixa de areia? ", sc, a.getPossuiCaixaDeAreia()));
		return a;
	}
}
